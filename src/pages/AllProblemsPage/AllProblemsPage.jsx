...
function AllProblemsPage() {
  ...
  return (
    <Box sx={{ minHeight: "100vh", px: { xs: 2, md: 6 }, py: 4, backgroundColor: "background.default" }}>
      <TopicGrid />
            ...
            <TableBody>
              {loading
                ...
                ? (
                  <TableRow>
                    <TableCell colSpan={6}>
                      <Typography sx={{ p: 4, textAlign: "center", color: theme.palette.error.main }}>
                        {error}
                      </Typography>
                    </TableCell>
                  </TableRow>
                ...
                ? (
                  <TableRow>
                    <TableCell colSpan={6}>
                      <Typography sx={{ p: 4, textAlign: "center" }}>No problems found</Typography>
                    </TableCell>
                  </TableRow>
                )
                        ...
                        <TableCell>
                          ...
                          <Box sx={{ mt: 0.5, display: "flex", gap: 0.5, flexWrap: "wrap" }}>
                            ...
                            {!expanded && tags.length > 3 && (
                              <Chip label={`+${tags.length - 3}`} size="small" onClick={() => toggleExpand(p.id)} />
                            )}
                          </Box>
                        </TableCell>
                        <TableCell>
                          <Chip label={p.difficulty} size="small" sx={{ backgroundColor: diff.background, color: diff.text, fontWeight: 600 }} />
                        </TableCell>
